...
if __name__ == "__main__":
    ...
    test_cases = [
        GemmTestCase(
            random_tensor((8192, 8192), np.float32),
            None,
            random_tensor((8192, 8192), np.float32),
            None,
            random_tensor((8192, 8192), np.float32),
        ...
        GemmTestCase(
            random_tensor((8192, 8192), np.float16),
            None,
            random_tensor((8192, 8192), np.float16),
            None,
            random_tensor((8192, 8192), np.float16),
        ...
        GemmTestCase(
            random_tensor((512, 5120), np.float32),
            None,
            random_tensor((5120, 5120), np.float32),
            None,
            random_tensor((512, 5120), np.float32),
            None,
            1.0,
        ...
        GemmTestCase(
            random_tensor((512, 5120), np.float16),
            None,
            random_tensor((5120, 5120), np.float16),
            None,
            random_tensor((512, 5120), np.float16),
            None,
            1.0,
        ...
        GemmTestCase(
            random_tensor((512, 5120), np.float32),
            None,
            random_tensor((5120, 13824), np.float32),
            None,
            random_tensor((512, 13824), np.float32),
            None,
            1.0,
            0.0,
        ),
        ...
        GemmTestCase(
            random_tensor((512, 5120), np.float16),
            None,
            random_tensor((5120, 13824), np.float16),
            None,
            random_tensor((512, 13824), np.float16),
            None,
            1.0,
            0.0,
        ),
